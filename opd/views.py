...
def get_meta(request,obj,context,jenis):
	...
	if jenis==_U:
		...
		for i in a:context[B]=D%(request.scheme,request.get_host(),_U,i.judul_seo);context[E]=Truncator(strip_tags(i.isi_berita)).chars(160).strip();context['published_time']=i.created_at;context['modified_time']=i.updated_at;print("context['news_url'] = ");print(context[B])
